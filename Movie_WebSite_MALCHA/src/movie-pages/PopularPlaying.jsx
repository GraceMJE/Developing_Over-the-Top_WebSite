...
// 영화 데이터를 가져오는 함수
const fetchPopularPlayingMovies = async ({ pageParam = 1 }) => {
  const response = await axios.get(
    `https://api.themoviedb.org/3/movie/popular?api_key=${myAPIkey}&language=ko-KR&page=${pageParam}`
  );
